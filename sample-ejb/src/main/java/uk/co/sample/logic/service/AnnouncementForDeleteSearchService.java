...
@Stateless
public class AnnouncementForDeleteSearchService {
    ...
    public List<AnnouncementForDeleteSearchBean> doSearch(AnnouncementForDeleteListSearchRequestDTO requestDTO) {
    ...
    // ***** protected method *****
    // ***** private method *****
    private SQLBuilder createNativeSQLBuilder(AnnouncementForDeleteListSearchRequestDTO requestDTO) {
