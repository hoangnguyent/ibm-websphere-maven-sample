...
public abstract class AbstractSoapException extends RuntimeException {

    private static final long    serialVersionUID = 738255590967988045L;

    private final Set<ErrorData> errDataSet       = new HashSet<>();

    protected AbstractSoapException() {

    }

    protected AbstractSoapException(Throwable t) {
        super(t);
    }
    ...
    public void addException(AbstractSoapException exception) {
